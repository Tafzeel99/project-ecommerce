...
import { CategorySofaData } from '@/sanity/lib/getProductData'
...
export default async function Sofa() {
  const data: IProduct[] = await CategorySofaData();
  const discountValue: number = 2
  return (
    <>
      <MainHeader title='Sofa' prev='Home . Pages . ' current='Categories.Sofa' />
